...
class CalendarManager:
    ...
    def create_calendar(self, name: str, color: str) -> Calendar:
        """Creates a new calendar."""
        calendar = self._event_store.calendarForEntityType(
            EKEntityTypeReminder, self._event_store
        )
        calendar.setTitle_(name)
        calendar.setColor_(color)
        self._event_store.saveCalendar_commit_error_(calendar, True, None)
        return Calendar(id=calendar.calendarIdentifier(), name=name, color=color)
...
class RemindKit:
    ...
    def list_calendars(self) -> Generator[Calendar, None, None]:
        """Lists all calendars."""
